...
- a) Descriptivo (lo relacionado con el pasado)
- b) Dashboard (filtros KPIs, visualizaciones)
- c) Predictivo (intentando predecir el futuro o eventos futuros , o el resultado posible de la variable)
- d) Prescriptivo (que tareas voy a ejecutar a partir de ya conocer el comportamiento de la variable)
...
Gráfico de columnas/lineas, podría ser:<br>
Eje x = modelos de vehículos.<br>
Eje y = Velocidad promedio de frenado.<br>
- b) Costo de una llamada por segundos.<br>
Gráfico de líneas:(si quisiese representarlo con grafico de barras deberia discretizar la variable del costo de llamada)
